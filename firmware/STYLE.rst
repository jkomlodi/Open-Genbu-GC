...
Coding Style
=================
Shamelessly stolen from QEMU, there will still be some references in
here that I forgot to get rid of or are too lazy to get rid of.
...
Avoid usng heap memory, create your own allocator if needed
